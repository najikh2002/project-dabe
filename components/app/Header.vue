    ...
    <div class="container mx-auto px-4">
      <div class="flex items-center justify-between h-20">
        <div class="flex-shrink-0">
          <NuxtLink
            to="/"
            class="text-white text-3xl font-bold flex items-center"
          >
            <img
        ...
        <div class="hidden md:flex items-center space-x-6 text-white">
          <NuxtLink
            to="/"
            class="hover:text-teal-100 font-medium relative group"
            ><span>Beranda</span
            ><span
              class="absolute bottom-0 left-0 w-full h-0.5 bg-teal-100 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 ease-out"
            ></span>
          </NuxtLink>
          <NuxtLink
            to="/grafik"
            ...
            <transition name="fade">
              ...
              >
                ...
                <a
                  @click="logout"
                  href="#"
                  class="block px-4 py-2 text-sm text-red-600 hover:bg-red-100 hover:text-red-700"
                  >Log Out</a
                >
              </div>
            </transition>
    ...
    <transition name="slide-fade">
      <div v-if="mobileMenuOpen" class="md:hidden bg-teal-500 pb-3 shadow-lg">
        ...
        >
          Beranda</NuxtLink
        >
        <!-- Perbaiki typo Infografis menjadi Grafik -->
        <NuxtLink
          to="/grafik"
          class="block px-4 py-3 text-white hover:bg-teal-600 transition-colors duration-150"
          >Grafik
...
export default {
  ...
  methods: {
    ...
    logout() {
      ...
      // Hapus semua cookie manual (jika kamu tidak pakai useCookie dari Nuxt)
